...
namespace Framework.WebApi
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        protected IActionResult R<T>(int code, string message, T? data = default)
        {
        ...
        protected IActionResult Success(string message = ResponseCode.SUCCESS_MESSAGE) => R(ResponseCode.SUCCESS, message);
        ...
        protected IActionResult Success<T>(T data) => R(ResponseCode.SUCCESS, ResponseCode.SUCCESS_MESSAGE, data);
        ...
        protected IActionResult Success<T>(string message, T data) => R(ResponseCode.SUCCESS, message, data);
        ...
        protected IActionResult Fail(string message = ResponseCode.ERROR_MESSAGE) => R(ResponseCode.ERROR, message);
        ...
        protected IActionResult Fail<T>(T data) => R(ResponseCode.ERROR, ResponseCode.ERROR_MESSAGE, data);
        ...
        protected IActionResult Fail<T>(string message, T data) => R(ResponseCode.ERROR, message, data);
        ...
        {
            var result = new BadRequestObjectResult(new Result
            {
                Code = code,
                Message = message
            });
        ...
        {
            var result = new BadRequestObjectResult(new Result<T>
            {
                Code = code,
                Data = data,
                Message = message
